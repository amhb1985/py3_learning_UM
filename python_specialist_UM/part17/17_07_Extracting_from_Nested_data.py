...
'''
'''
#another test for extracting something in tweet for the Level 3:
import json
print(type(res))
print(res.keys())
res2 = res['statuses']
...
#now we can set our results with the time information , here for our result in Level 4:
...
for res3 in res2[:1]:
   ...
   # print(res4.keys()) after running we'll see the time of creat of it 
   print(res4['screen_name'], res4['created_at'])

'''


#we can easy write this code to do all of above(in another hand is samwe as above:):
